...
const payloads = {
    ...
    putMany: (sceneKey, viewKey, records, progress) => createApiPayloadPutMany(sceneKey, viewKey, records)
};
...
var hasRequired_fetch;

function require_fetch () {
	if (hasRequired_fetch) return _fetch.exports;
	hasRequired_fetch = 1;
	...
	if(typeof commonjsRequire != 'undefined') _fetch.exports = _fetch$1;
	return _fetch.exports;
}

var knackApiHelper;
var hasRequiredKnackApiHelper;

function requireKnackApiHelper () {
	if (hasRequiredKnackApiHelper) return knackApiHelper;
	hasRequiredKnackApiHelper = 1;
	const _fetch = require_fetch();
	...
	knackApiHelper = KnackAPI;
	return knackApiHelper;
}

var knackApiHelperExports = requireKnackApiHelper();
var KnackAPI = /*@__PURE__*/getDefaultExportFromCjs(knackApiHelperExports);
...
export { knackApi };
//# sourceMappingURL=bimsc-knack-api.bundle.js.map
